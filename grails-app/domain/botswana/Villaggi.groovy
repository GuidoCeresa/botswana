...
class Villaggi {
    ...
    static constraints = {
        csonome()
        nome()
        sottodistretto(nullable: true, blank: true)
        popolazione(nullable: true, blank: true)
        localita(nullable: true, blank: true)
        latitudine(nullable: true, blank: true)
        longitudine(nullable: true, blank: true)
